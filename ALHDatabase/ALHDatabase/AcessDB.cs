...
namespace ALHDatabase
{
    class AcessDB
    {
        ...
        //String para a conexão, manter local para uso multi-pc
        private static string strConnString = "Data Source=(local);Initial Catalog=AirLiquideHDB;Integrated Security=True";
